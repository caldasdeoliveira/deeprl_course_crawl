...
python -m ipykernel install --user --name drl_crawl --display-name "drl_crawl"

# Download and unzip the Unity environment
curl -O  https://s3-us-west-1.amazonaws.com/udacity-drlnd/P2/Crawler/Crawler.app.zip
unzip Crawler.app.zip
rm Crawler.app.zip